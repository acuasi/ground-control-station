define(['backbone', 'leaflet'], function(Backbone, L) {
  ...
  /*
  This weird bit is because this plugin needs a place of its own, and I'm too tired to do it right now.
  Leave it until it can be integrated properly into the require sequence.
  */
